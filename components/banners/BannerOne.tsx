      ...
      <div className="max-w-screen-2xl mx-auto px-4 md:px-8 flex flex-col-reverse lg:flex-row items-center justify-between">
        <div className="flex flex-col justify-center items-center text-center lg:text-left lg:w-1/2">
          <p className="text-white font-semibold text-lg lg:text-xl">
            <LucideRocket className="inline-block mr-2 -mb-2" size={24} /> Special Offer
          </p>
        ...
        <div className="relative lg:w-1/2  lg:mt-0">
          <div className="rounded-xl overflow-hidden">
            <Image src="/images/banner/headphone.png" className="object-contain" alt="Electronics Banner" width={500} height={400} />
          </div>
