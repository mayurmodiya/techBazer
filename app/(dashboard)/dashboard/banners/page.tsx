  ...
  return (
    <div className="bg-white dark:bg-gray-800 min-h-screen w-full my-4 rounded-md">
      <div className="max-w-screen-2xl w-full mx-auto px-4 py-6">
        ...
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">Manage Banners</h1>
        <div className="flex justify-end">
          <Link href={'/dashboard/banners/add-banner'} className="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded-lg">Add Banner</Link>
        </div>
        </div>
