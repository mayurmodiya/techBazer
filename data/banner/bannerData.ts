...
export const bannerData = [
    {
        ...
        images:['/images/banner/gaming-laptop.png','/images/shapes/indicate-banner.svg'],
        button:'Shop Gaming Laptops',
        discountText:'Buy now Get 30% off'
    },
    {
        ...
        images:['/images/banner/iphone.png','/images/shapes/indicate-banner.svg'],
        button:'Order Now',
        discountText:'Buy now Get 30% off'
    },
    {
        ...
        images:['/images/banner/headphone.png','/images/shapes/indicate-banner.svg'],
